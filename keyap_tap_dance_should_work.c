...
void email_finished(qk_tap_dance_state_t *state, void *user_data) {
  ...
  switch (email_state.state) {
    ...
    case TD_DOUBLE_TAP: SEND_STRING("rick.c.kremer@gmail.com"); break; // send email address
    case TD_TRIPLE_TAP: SEND_STRING("rkremer@bushelpowered.com"); // send work email
  }
}
